...
<div class="home-release-note">
  <span>适用版本：iWriter <code>0.1.5</code></span>
  <span>最后更新：2026-04-23</span>
</div>
...
<section class="home-feature-stack">
  ...
  <div class="home-feature-row">
    ...
    <div class="home-feature-text">
      ...
      <h2>你的地盘你做主</h2>
      <p>
        你的本地文件或者远程云盘，你熟悉的Markdown文本格式，基于操作系统目录的纯文件工作区、目录树，增删除、拷贝、黏贴、拖拽、跨文件搜索与替换，想怎么操作你的资产就怎么操作。资料、草稿，脑爆巧思、几审作品，可以自行组织和管理。
      </p>
      <p>
  ...
  <div class="home-feature-row">
    <div class="home-feature-text">
      ...
      <p>
        专注模式、打字机模式、简洁模式，你只需关注手头文字，没有任何干扰。支持各种打印排版格式：小说、简历等，输出PDF。
      </p>
      <p>
