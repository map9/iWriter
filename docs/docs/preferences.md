...
`偏好设置` 用于管理 iWriter 的工作区、编辑体验、拼写与语法检查、主题、导入导出、AI 提供方以及应用更新行为。当前界面分为 `工作区`、`编辑器`、`拼写与语法`、`显示`、`打印与PDF输出`、`导出`、`AI`、`更新` 八个分组。
...
- 想控制 `.gitignore` 在不同工作区功能中的过滤范围，或 Git 提交按钮在无暂存内容时的行为
...
Git 面板的完整说明见 [Git 源代码管理](/docs/source-control)。
