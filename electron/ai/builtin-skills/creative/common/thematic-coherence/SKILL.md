...
A story is trying to answer a question about human experience. Surface questions ("会不会活下来？" "能不能得到？") are not it. Thematic questions ("想要这个东西要付出什么代价？" "追求它的过程中他发现了自己的什么？") are. The thematic question should be one the story **cannot answer cleanly** — clean answers produce messages; irresolvable tensions produce meaning.
