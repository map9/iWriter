...
- 每条线一个核心句；每个阶段默认一个因果句。单句无法无损表达关键因果、信息差或限制时，增加最少必要的补充行，或拆成两个稳定 ID 阶段。
...
- 总纲只保存全书顺序、节点间因果、故事线交汇和结局落点，不复制 `project.md`、人物小传或完整故事线。
...
- 会改变本章行动可行性的伤势、位置、持有物、知情范围、承诺或临时关系状态，若不能从相邻正文结尾和场景句直接判断，补一行最短的 `开始条件`；只记录本章实际会使用的状态。
