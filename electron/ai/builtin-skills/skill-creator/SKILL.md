...
### Skill Location in iWriter

iWriter stores deepagents skills in:
...
For iWriter, use the app's skills directory:

```bash
npx tsx scripts/init_skill.ts <skill-name> --path ~/.iwriter/ai/skills
```
