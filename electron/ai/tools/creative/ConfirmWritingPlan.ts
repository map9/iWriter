...
export function buildConfirmWritingPlanTool(): StructuredTool {
  return tool(
    ...
    },
    {
      ...
      description: 'Ask the author to approve or edit a writing plan before drafting a scene/chapter or a large rewrite/restructure. The approved (or author-edited) plan authorizes the writing session and is the fidelity baseline for later review.',
      schema: z.object({
