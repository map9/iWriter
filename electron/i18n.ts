...
const enUS: LocaleMessages = {
  ...
  'menu.view.pageWidth': 'Page Width',
  'menu.view.pageWidthStandard': 'Standard',
  'menu.view.pageWidthMedium': 'Medium',
  'menu.view.pageWidthLarge': 'Large',
  'menu.view.pageWidthFitWindow': 'Fit Window',
  'menu.paragraph.quoteBlock': 'Quote Block',
  'menu.paragraph.alertBlock': 'Alert Block',
  'menu.paragraph.alert.note': ' Note Block',
  'menu.paragraph.alert.tip': 'Tip Block',
  'menu.paragraph.alert.important': 'Important Block',
  'menu.paragraph.alert.warning': 'Warning Block',
  'menu.paragraph.alert.caution': 'Caution Block',
  'menu.paragraph.alert.beat': 'Beat Block',
  'menu.paragraph.alert.comment': 'Comment Block',
...
const zhCN: LocaleMessages = {
  ...
  'menu.view.pageWidth': '页面宽度',
  'menu.view.pageWidthStandard': '标准',
  'menu.view.pageWidthMedium': '中等',
  'menu.view.pageWidthLarge': '宽屏',
  'menu.view.pageWidthFitWindow': '适应窗口',
  'menu.paragraph.quoteBlock': '引用块',
  'menu.paragraph.alertBlock': 'Alert 块',
  'menu.paragraph.alert.note': '提示块',
  'menu.paragraph.alert.tip': '建议块',
  'menu.paragraph.alert.important': '重要块',
  'menu.paragraph.alert.warning': '警告块',
  'menu.paragraph.alert.caution': '注意块',
  'menu.paragraph.alert.beat': '节拍块',
  'menu.paragraph.alert.comment': '批注块',
...
const zhMenuLabelMap: MenuLabelMap = {
  ...
  'Wrapped Scrolling': '平铺滚动',
  'Page Scrolling': '页面滚动',
  'Presentation': '演示模式',
  'Spread': '视图',
  'Single Page View': '单页视图',
  'Double Page View': '双页视图',
  'Book View': '书籍视图',
  'Rotate Left': '逆时针旋转',
  'Rotate Right': '顺时针旋转',
  Help: '帮助',
