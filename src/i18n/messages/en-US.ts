  ...
  preferences: {
    ...
    ai: {
      ...
      webSearch: {
        ...
        enableHint: 'When enabled, the Agent can use web_search / fetch_url tools to browse the internet',
        engineType: 'Engine type',
        customEngine: 'Custom engine',
        baseUrl: 'Endpoint URL',
        baseUrlHint: 'Tavily: leave empty to use the default endpoint. SearXNG / custom: required.',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key (optional)',
        apiKeyHint: 'Required for Tavily. Leave empty for SearXNG instances without authentication.',
      },
      actions: 'Actions',
