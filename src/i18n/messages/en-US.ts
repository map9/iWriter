export default {
  ...
  agentPanel: {
    ...
    creativeReview: {
      ...
      gitInitRepositoryLocation: 'Repository location',
      gitInitWillCreate: 'Will create',
      gitInitCurrentDirectory: 'Current directory',
      gitInitEntryCount: '{files} files · {directories} directories',
      gitInitIgnoreRules: 'Ignore rules',
      gitRestoreSource: 'Restore source',
      gitRestoreIndexSource: 'Index version',
      gitRestoreFiles: 'Files to restore ({count})',
      gitRestoreTotal: 'Total',
      gitRestoreTotalStats: '{files} files · +{additions} −{deletions}',
      gitRestoreFileCount: '{count} files',
