export default {
  ...
  agentPanel: {
    ...
    toolbar: {
      ...
      automaticCompactHint: 'History is compacted automatically at the threshold',
      compactKeep: 'Keeps about {keep} recent tokens after compaction',
      requestBudget: 'Per-request runtime budget: {max} tokens',
