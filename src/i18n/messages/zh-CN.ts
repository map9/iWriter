export default {
  ...
  preferences: {
    ...
    sourceControl: {
      ...
      localIdentityDesc: '继承全局身份，或仅为当前工作区仓库设置独立身份。',
  ...
  agentPanel: {
    ...
    toolbar: {
      ...
      requestBudget: 'iWriter 运行预算：{max} tokens',
    ...
    creativeReview: {
      ...
      gitTagName: '标签名',
      gitTagMessage: '标签说明',
      gitInitRepositoryLocation: '仓库位置',
      gitInitWillCreate: '将创建',
      gitInitCurrentDirectory: '当前目录',
      gitInitEntryCount: '{files} 个文件 · {directories} 个目录',
      gitInitIgnoreRules: '忽略规则',
      gitRestoreSource: '恢复来源',
      gitRestoreIndexSource: '暂存区版本（index）',
      gitRestoreFiles: '恢复文件（{count}）',
      gitRestoreTotal: '合计',
      gitRestoreTotalStats: '{files} 个文件 · +{additions} −{deletions}',
      gitRestoreFileCount: '{count} 个文件',
  ...
  statusBar: {
    ...
    updateStatus: {
      ...
      checkError: '检查更新失败：{message}\n点击重新检查。',
      downloadError: '下载更新失败：{message}\n点击查看详情并重试。',
      installError: '安装更新失败：{message}\n点击查看详情并重试。',
      unknownError: '未知错误',
    },
  },
}
