<template>
  <div class="relative flex-shrink-0" v-click-outside="() => showMenu = false">
    ...
    >
      <button @click="emit('attach-current'); showMenu = false" class="w-full flex items-center gap-2 px-3 py-1.5 text-xs text-gray-700 hover:bg-gray-50">
        <IconFileText class="w-3.5 h-3.5 text-gray-400 flex-shrink-0" />当前文件
      </button>
...
import { ref } from 'vue'
import { IconPaperclip, IconFileText, IconFile, IconFolder } from '@tabler/icons-vue'
