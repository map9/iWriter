  ...
  >
    ...
    >
      ...
      <button
        ...
        class="btn btn-ghost btn-square btn-xs border-none opacity-0 pointer-events-none transition-opacity duration-150 group-hover:opacity-100 group-hover:pointer-events-auto hover:bg-transparent"
